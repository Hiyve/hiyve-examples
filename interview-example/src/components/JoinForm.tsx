/**
 * @fileoverview Pre-join form for video interview sessions.
 * @module interview-example/components/JoinForm
 *
 * Pre-join form for creating or joining a video interview session. Includes
...
const STORAGE_KEYS = {
  ...
  userRole: 'hiyve-interview-example-userRole',
};
...
export function JoinForm({ onBack }: JoinFormProps) {
  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 4 }}>
      ...
      <Paper sx={{ p: 4 }}>
        <Typography variant="h4" gutterBottom align="center">Interview Room</Typography>
