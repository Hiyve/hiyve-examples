/**
 * @fileoverview CloudClient context provider and hook.
 * @module sales-example/cloudClient
 *
 * Creates a CloudClient instance with generateCloudToken and provides
 * it via React context. Components use useCloudClient() to get the
 * instance for useAnalysis and useSearch hooks.
 */
