/**
 * @fileoverview Pre-join form for video sales calls.
 * @module sales-example/components/JoinForm
 *
 * Pre-join form for creating or joining a video sales call. Includes
...
const STORAGE_KEYS = {
  ...
  userRole: 'hiyve-sales-example-userRole',
};
...
export function JoinForm({ onBack }: JoinFormProps) {
  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 4 }}>
      ...
      <Paper sx={{ p: 4 }}>
        <Typography variant="h4" gutterBottom align="center">Sales Call</Typography>
        <Typography variant="body2" color="text.secondary" align="center" sx={{ mb: 3 }}>
          Start or join a sales video call
        </Typography>
