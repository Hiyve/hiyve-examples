# Telehealth Visit Notes - Hiyve SDK Example
...
- **File Management** - Access documents and past visit files in the sidebar Files tab
- **Engagement Tracking** - Per-participant engagement overlays on video tiles

### During the Visit (Patient/Guest)
...
1. Host creates room and starts recording/transcription via ControlBar intelligence menu
...
| Sidebar not visible | Only the room host sees the sidebar; guests see video only |
