...
function serializeProps(props: Record<string, unknown>): string {
  ...
  return JSON.stringify(props, (_key, value) => {
    ...
    if (value !== null && typeof value === 'object') {
      // Detect React elements ($$typeof is a Symbol)
...
export function WaitingRoomAdmittance(props: Record<string, unknown>) {
  return <div data-testid="waiting-room-admittance" data-props={serializeProps(props)} />;
}

export function WaitingRoomGuest(props: Record<string, unknown>) {
  return <div data-testid="waiting-room-guest" data-props={serializeProps(props)} />;
}

export function ParticipantList(props: Record<string, unknown>) {
  return <div data-testid="participant-list" data-props={serializeProps(props)} />;
}

export function GainControl(props: Record<string, unknown>) {
  return <div data-testid="gain-control" data-props={serializeProps(props)} />;
}
...
export const presentationLayoutHandler = vi.fn();

export type ControlBarLayoutMode = 'grid' | 'speaker' | 'sidebar' | 'presentation';
export type LayoutDefinition = { id: string; label: string; icon?: unknown };
